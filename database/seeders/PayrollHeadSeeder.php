...
class PayrollHeadSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $all_member = array(
            ...
            ['name' => 'Recovery for Car', 'slug' => 'recovery_for_car', 'placeholder' => 'Recovery for Car', 'employment_type' => 'local', 'for' => 'payscale', 'is_dropdown' => 'no','head_type'=>"deduction", 'created_by' => 1,],
