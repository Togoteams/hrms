...
class PayrollHeadSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $all_member = array(
            ...
            ['name' => 'Personal Loan', 'slug' => 'personal_loan', 'placeholder' => 'Personal Loan', 'employment_type' => 'local', 'for' => 'salary', 'is_dropdown' => 'no','head_type'=>"deduction", 'created_by' => 1],
            ['name' => 'Car Loan', 'slug' => 'car_loan', 'placeholder' => 'Car Loan', 'employment_type' => 'local', 'for' => 'salary', 'is_dropdown' => 'no','head_type'=>"deduction", 'created_by' => 1],
            ['name' => 'Mortgage Loan', 'slug' => 'mortgage_loan', 'placeholder' => 'Mortgage Loan', 'employment_type' => 'local', 'for' => 'salary', 'is_dropdown' => 'no','head_type'=>"deduction", 'created_by' => 1],
            ['name' => 'Salary advance', 'slug' => 'salary_advance', 'placeholder' => 'Salary advance', 'employment_type' => 'local', 'for' => 'salary', 'is_dropdown' => 'no','head_type'=>"deduction", 'created_by' => 1],
