...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('payroll_salaries', function (Blueprint $table) {
            ...
            $table->double('net_take_home',10,3);
            $table->double('net_take_home_in_pula',10,3)->nullable();
            $table->double('usd_pula_currency_amount',10,3)->nullable();
            $table->double('total_deduction',10,3);
            $table->double('gross_earning',10,3);
