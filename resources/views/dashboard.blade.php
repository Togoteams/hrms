...
<main id="content" role="main" class="main">
      ...
      <div class="col-lg-5 mb-3 mb-lg-5">
        ...
        <div class="card h-100">
          ...
          <div class="card-header card-header-content-between">
            <h4 class="card-header-title">Import data into HRMS Dashboard</h4>
          ...
          <!-- Body -->
          <div class="card-body">
            <p>See and talk to your users and leads immediately by importing your data into the Dashboard</p>
            ...
            <ul class="list-group list-group-flush list-group-no-gutters">
              ...
              <li class="list-group-item"><span class="small text-muted">Or you can <a class="link" href="#">sync data to HRMS</a> to ensure your data is always up-to-date.</span></li>
            </ul>
          </div>
          <!-- End Body -->
        </div>
        ...
        <table id="datatable" class="table table-borderless table-thead-bordered table-nowrap table-align-middle card-table" data-hs-datatables-options='{
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>Subscription</td>
              <td>example@exchangeofservices.com</td>
              <td>6 months ago</td>
              <td>78463</td>
            </tr>
    ...
    <div class="row">
      <div class="col-lg-6 mb-3 mb-lg-0">
        ...
        <div class="card h-100">
          <!-- Header -->
          <div class="card-header card-header-content-sm-between">
            <h4 class="card-header-title mb-2 mb-sm-0">Exchanges</h4>
      ...
      <div class="col-lg-6">
        ...
        <div class="card h-100">
          ...
          <!-- Body -->
          <div class="card-body">
            <span class="h1 d-block mb-4">£7,431.14 GBP</span>
  ...
  <div class="footer">
    <div class="row justify-content-between align-items-center">
      <div class="col">
        <p class="fs-6 mb-0">&copy; Exchange of Services. <span class="d-none d-sm-inline-block">2023 Spotlight Studios.</span></p>
      </div>
      <!-- End Col -->
