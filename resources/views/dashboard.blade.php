                ...
                <div class="col-lg-5 mb-3 mb-lg-5">
                    ...
                    <div class="card h-100">
                        ...
                        <div class="card-header card-header-content-between">
                            <h4 class="card-header-title">Import data into EOS Dashboard</h4>
                        ...
                        <!-- Body -->
                        <div class="card-body">
                            <p>See and talk to your users and leads immediately by importing your data into the Dashboard
                            </p>
                            ...
                            <ul class="list-group list-group-flush list-group-no-gutters">
                                ...
                                <li class="list-group-item"><span class="small text-muted">Or you can <a class="link"
                                            href="#">sync data to EOS</a> to ensure your data is always
                                        up-to-date.</span></li>
                            </ul>
                        </div>
                        <!-- End Body -->
