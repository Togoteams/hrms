<div class="row">
    ...
    <div class="mb-2 col-sm-4">
        <div class="form-group">
            ...
            <input disabled required id="email" placeholder="Enter correct email   "
                value="{{ $data->user->email }}" type="email" name="email" class="form-control form-control-sm ">
        </div>
    </div>
    <div class="mb-2 col-sm-4">
        <div class="form-group">
            ...
            <input disabled required id="mobile" placeholder="Enter correct Mobile No   "
                value="{{ $data->user->mobile }}" type="number" name="mobile" class="form-control form-control-sm ">
        </div>
    </div>
    {{-- <div class="mb-2 col-sm-4">
            <div class="form-group">
    ...
    <div class="mb-2 col-sm-4">
        <div class="form-group">
            ...
            <input disabled required id="ec_number" placeholder="Enter correct ec number   "
                value="{{ $data->ec_number }}" type="text" name="ec_number" class="form-control form-control-sm ">
        </div>
    </div>
    ...
    <div class="mb-2 col-sm-4">
        <div class="form-group">
            ...
            <input disabled required id="id_number" placeholder="Enter correct id number   "
                value="{{ $data->id_number }}" type="text" name="id_number" class="form-control form-control-sm ">
        </div>
    </div>
    <div class="mb-2 col-sm-4">
        <div class="form-group">
            <label for="contract_duration">contract duration</label>
            <input disabled required id="contract_duration" placeholder="Enter correct contract duration   "
    ...
    <div class="mb-2 col-sm-4">
        <div class="form-group">
            ...
            <input disabled required id="bank_holder_name" placeholder="Enter correct bank holder name   "
                type="text" value="{{ $data->bank_holder_name }}" name="bank_holder_name"
                class="form-control form-control-sm ">
        </div>
    </div>
    <div class="mb-2 col-sm-4">
        <div class="form-group">
            ...
            <input disabled required id="ifsc" placeholder="Enter correct ifsc   " type="text"
                name="ifsc" value="{{ $data->ifsc }}" class="form-control form-control-sm ">
        </div>
    </div>
