    ...
    <div class="page-header">
      <div class="row align-items-end">
        ...
        <div class="col-sm-auto">
          <a class="btn btn-primary g-popup" href="javascript:;" data-bs-toggle="modal" data-action="add" data-bs-target="#addEditRoleModal">
    ...
    <div class="card">
      ...
      <div class="card-header card-header-content-md-between">
        <div class="mb-2 mb-md-0">
          <form>
            ...
            <div class="input-group input-group-merge input-group-flush">
              ...
              <input id="datatableSearch" type="search" class="form-control" placeholder="Search roles" aria-label="Search roles">
            </div>
            <!-- End Search -->
          </form>
        </div>
        ...
        <div class="d-grid d-sm-flex justify-content-md-end align-items-sm-center gap-2">
          ...
          <!-- Dropdown -->
          <div class="dropdown">
            <button type="button" class="btn btn-white btn-sm dropdown-toggle w-100" id="rolesExportDropdown" data-bs-toggle="dropdown" aria-expanded="false">
              <i class="bi-download me-2"></i> Export
            </button>

            <div class="dropdown-menu dropdown-menu-sm-end" aria-labelledby="rolesExportDropdown">
          ...
          <!-- Dropdown -->
          <div class="dropdown">
            <button type="button" class="btn btn-white btn-sm w-100" id="rolesFilterDropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
              <i class="bi-filter me-1"></i> Filter <span class="badge bg-soft-dark text-dark rounded-circle ms-1">2</span>
            </button>

            <div class="dropdown-menu dropdown-menu-sm-end dropdown-card card-dropdown-filter-centered" aria-labelledby="rolesFilterDropdown" style="min-width: 22rem;">
              <!-- Card -->
              <div class="card">
                <div class="card-header card-header-content-between">
                  <h5 class="card-header-title">Filter roles</h5>
                      ...
                      <div class="row">
                        <div class="col">
                          ...
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="rolesFilterCheckAll" checked>
                            <label class="form-check-label" for="rolesFilterCheckAll">
                              All
                            </label>
                          </div>
                          <!-- End Check -->
                        ...
                        <div class="col">
                          <!-- Check -->
                          <div class="form-check">
                            <input class="form-check-input" type="checkbox" value="" id="rolesFilterCheckVendor">
                            <label class="form-check-label" for="rolesFilterCheckVendor">
                              Vendor
                            </label>
                          </div>
                          <!-- End Check -->
      ...
      <div class="modal-body">
        ...
        <form method="post" action="{{route('admin.role.add')}}" class="formsubmit">
          ...
          <div class="row mb-4">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" rows="4" cols="50" name="short_code" id="short_code" placeholder="Short Code" aria-label="Short Code">
            </div>
          </div>
          <!-- End Form -->
          <div class="row mb-4">
            ...
            <div class="col-sm-9">
              <select class="js-select form-select" autocomplete="off" name="role_type" id="role_type" data-hs-tom-select-options='{
                                  "searchInDropdown": false,
                                  "hideSearch": true
                                }'>
          ...
          <div class="row mb-4">
            ...
            <div class="col-sm-9">
              <textarea type="text" class="form-control" rows="4" cols="50" name="description" id="description" placeholder="Role Description" aria-label="Description"></textarea>
            </div>
          </div>
