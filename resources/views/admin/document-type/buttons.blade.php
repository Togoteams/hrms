<div class="button-container">
    <div class="row">
       <div class="d-flex">
            <button type="button" data-table="document_type" data-uuid="{{$item->id}}"
            ...
            <form id="edit{{ $item->id }}"
                action="{{ route('admin.document_type.destroy', $item->id) }}">

                <button type="button"
                    onclick="editForm('{{ route('admin.document_type.edit', $item->id) }}', 'edit')"
