    ...
    <div class="row">
        <div class="col-sm-12 mb-2">
            <div class="form-group">
                ...
                <input required id="name" placeholder="Enter Name of Membership " value="{{ $data->name }}"
        ...
        <div class="col-sm-12 mb-2">
            <div class="form-group">
                ...
                <input required id="amount" placeholder="Enter amount of Membership " value="{{ $data->amount }}"
        ...
        <div class="col-sm-12 mb-2">
            <div class="form-group">
                ...
                <input required id="type" placeholder="Enter type of Membership " value="{{ $data->type }}"
        ...
        <div class="col-sm-12 mb-2">
            <div class="form-group">
                ...
                <input required id="membership_code" placeholder="Enter membership_code of Membership "
                    value="{{ $data->membership_code }}" type="text" name="membership_code"
