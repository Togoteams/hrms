    ...
    <div class="row">
        <div class="col-sm-12 mb-2">
            <div class="form-group">
                ...
                <input required id="name" placeholder="Enter Name of Membership " value="{{ $data->name}}" type="text" name="name"
        ...
        <div class="col-sm-12 mb-2">
            <div class="form-group">
                ...
                <input required id="amount" placeholder="Enter amount of Membership " value="{{ $data->amount}}" type="text" name="amount"
                    class="form-control form-control-sm ">
            </div>
        </div>
        <div class="col-sm-12 mb-2">
            <div class="form-group">
                ...
                <input required id="type" placeholder="Enter type of Membership " value="{{ $data->type}}" type="text" name="type"
                    class="form-control form-control-sm ">
            </div>
        </div>
        <div class="col-sm-12 mb-2">
            <div class="form-group">
                ...
                <input required id="membership_code" placeholder="Enter membership_code of Membership " value="{{ $data->membership_code}}" type="text"
