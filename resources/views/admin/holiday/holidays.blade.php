        ...
        <div class="mb-2 mb-md-0">
          <form>
            ...
            <div class="input-group input-group-merge input-group-flush">
              ...
              <input id="datatableSearch" type="search" class="form-control" placeholder="Search Holidays" aria-label="Search Holidays">
            </div>
            <!-- End Search -->
          </form>
        </div>
  ...
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="addEditHolidayModalLabel">Holiday:<span class="action_name">add</span></h5>
      ...
      <div class="modal-body">
        ...
        <form method="post" action="{{route('admin.holiday.add')}}" class="formsubmit">
          ...
          <div class="row mb-4">
            ...
            <div class="col-sm-9">
              <input type="date" class="form-control" rows="4" cols="50" name="date" id="date" placeholder="Date" aria-label="Date">
            </div>
          </div>
          <!-- End Form -->
          <div class="row mb-4">
            ...
            <div class="col-sm-9">
              <select class="js-select form-select" autocomplete="off" name="is_optional" id="is_optional" data-hs-tom-select-options='{
                                  "searchInDropdown": false,
                                  "hideSearch": true
                                }'>
          ...
          <div class="row mb-4">
            ...
            <div class="col-sm-9">
              <textarea type="text" class="form-control" rows="4" cols="50" name="description" id="description" placeholder="Holiday Description" aria-label="Description"></textarea>
            </div>
          </div>
