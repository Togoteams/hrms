    ...
    <div class="row">
        ...
        <div class="mb-2 col-sm-6">
            <div class="form-group">
                ...
                <input id="code" placeholder="Enter Code of Branch" type="text" name="code"
        ...
        <div class="mb-2 col-sm-6">
            <div class="form-group">
                ...
                <input id="city" placeholder="Enter City of Branch" type="text" name="city"
        ...
        <div class="mb-2 col-sm-6">
            <div class="form-group">
                ...
                <input id="state" placeholder="Enter State of Branch" type="text" name="state"
        ...
        <div class="mb-2 col-sm-6">
            <div class="form-group">
                ...
                <input id="country" placeholder="Enter Country of Branch" type="text" name="country"
        ...
        <div class="mb-2 col-sm-6">
            <div class="form-group">
                ...
                <input id="landmark" placeholder="Enter Landmark of Branch" type="text" name="landmark"
