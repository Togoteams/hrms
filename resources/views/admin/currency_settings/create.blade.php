                    ...
                    <div class="row">
                        ...
                        <div class="mb-2 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" required maxlength="7" minlength="3" pattern="[0-9]+"
                                    name="currency_amount_from" id="currency_amount_from" class="form-control"
                                    placeholder="Enter Currency Amount From">
                            </div>
                        </div>
                        ...
                        <div class="mb-2 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" required maxlength="7" minlength="3" pattern="[0-9]+"
                                    name="currency_amount_to" id="currency_amount_to" class="form-control"
