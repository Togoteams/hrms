               ...
               @endif
                <div class="p-5 card">
                    {{-- <form id="form_data" action="{{ route('admin.payroll.salary.store') }}"> --}}
                        <form action="{{ route('admin.payroll.reimbursement_type.update',$reimbursement->id) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            ...
                            {{-- <div class="mb-2 col-sm-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="slug" class="form-control" placeholder="Slug" value="{{$reimbursement->slug}}">
                                    <span class="text-danger">
                                        @error('slug')
                                        {{$message}}
                                        @enderror
