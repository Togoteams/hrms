               ...
               @endif
                <div class="p-5 card">
                    {{-- <form id="form_data" action="{{ route('admin.payroll.salary.store') }}"> --}}
                        <form action="{{ route('admin.payroll.reimbursement.update',$reimbursement->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            ...
                            {{-- <div class="mb-2 col-sm-3">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control" id="exampleInputName">
                                        ...
                                        <option @if ($reimbursement->status == '0') selected  @endif value="0">Pending</option>
                                        <option @if ($reimbursement->status == '1') selected  @endif value="1">Approved</option>
                                        <option @if ($reimbursement->status == '2') selected  @endif value="2">Reject</option>
                                    </select>
                                    <span class="text-danger">
                                        @error('status')
                                        {{$message}}
