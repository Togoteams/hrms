...
<div class="row">
    <div class="col-md-12">
        <h4>Earning</h4>
        @php
        $readonlyArr = ['bomaid','pension','union_fee','tax','over_time','house_up_keep_allow','provident_fund'];
...
<div class="row">
    ...
    <div class="mb-2 col-sm-4">
        <div class="form-group">
            ...
            <input required id="net_take_home" readonly placeholder="Enter correct Net Take Home" type="text" onkeyup="amount_cal(this)" value="{{ $data->net_take_home ?? ($grossEarning -  $totalDeduction) }}" name="net_take_home" class="form-control form-control-sm ">
        </div>
    </div>
</div>
</div>
