                     ...
                     <div id="employee">
                         @canany(['add-employees', 'edit-employees', 'view-employees', 'delete-employees',
                             ...
                             <div class="nav-item">
                                 ...
                                 <div id="employees"
                                     class="nav-collapse collapse {{ show(['designation.index', 'membership.index', 'branch.index', 'employees.index', 'department.index']) }}  "
                        ...
                        <div class="nav-item">
                            ...
                            <div id="report" class="nav-collapse collapse {{ show(['reports.annual-pay-report','reports.annula-tax-deduction','reports.thirteen-cheque-report','reports.branch-wise-employee-report','reports.leave-report']) }} "
                                data-bs-parent="#navbarReportMenu">
                                    ...
                                    <a class="nav-link {{ Route::getCurrentRoute()->getName() == 'admin.payroll.pf-for-ibo.report' ? 'active' : '' }}  "
                                        href="{{ route('admin.payroll.pf-for-ibo.report') }}">IBO PF Report</a>
